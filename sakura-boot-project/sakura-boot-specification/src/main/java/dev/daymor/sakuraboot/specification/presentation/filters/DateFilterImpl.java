...
import dev.daymor.sakuraboot.specification.api.presentation.filters.DateFilter;
 ...
 * @since  0.1.0
 */
@SuperBuilder(toBuilder = true, builderMethodName = "dateFilterBuilder")
@Getter
@EqualsAndHashCode(callSuper = true)
public class DateFilterImpl extends CommonFilterImpl<LocalDate>
    implements DateFilter<LocalDate> {

    @Serial
    private static final long serialVersionUID = 6132586416705655497L;
    ...
    public DateFilterImpl(
        @Nullable final LocalDate equal, @Nullable final List<LocalDate> in,
        @Nullable final LocalDate notEqual,
        @Nullable final List<LocalDate> notIn, @Nullable final Boolean isNull,
        @Nullable final LocalDate from, @Nullable final LocalDate to) {
