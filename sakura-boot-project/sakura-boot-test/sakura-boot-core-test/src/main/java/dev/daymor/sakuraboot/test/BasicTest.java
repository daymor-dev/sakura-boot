 ...
 *
 * <pre>
 * public class YourTest implements BasicTest&lt;YourEntity, YourIdType&gt; {
 *
...
public interface BasicTest<E extends DataPresentation<I>,
    I extends Comparable<? super I> & Serializable> extends SuperTest<I> {

    /**
     * Return a util class of type {@link BasicTestUtil}.
     *
     * @return A util class for testing.
     */
    @Override
    BasicTestUtil<E, I> getUtil();
}
