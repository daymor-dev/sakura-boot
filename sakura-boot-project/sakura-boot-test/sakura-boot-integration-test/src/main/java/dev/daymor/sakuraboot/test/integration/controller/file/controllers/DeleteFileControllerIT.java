...
package dev.daymor.sakuraboot.test.integration.controller.file.controllers;
...
import dev.daymor.sakuraboot.file.api.business.services.DeleteFileService;
import dev.daymor.sakuraboot.file.api.presentation.controllers.DeleteFileController;
import dev.daymor.sakuraboot.test.file.api.SuperFileTest;
 ...
 * public class YourIT //
 *     implements //
 *     DeleteFileControllerIT&lt;YourEntity, YourIdType, YourDataType&gt; {
 *
 ...
 * @since      0.1.2
 */
public interface DeleteFileControllerIT<E extends DataPresentation<I>,
    ...
    /**
     * Return a mock service that extends {@link DeleteFileService}.
    ...
    default void testDeleteFile() throws Exception {
        ...
        for (final String fileFieldName: getFileFieldNames()) {
            ...
            final ResultActions result
                = getMockMvc().perform(MockMvcRequestBuilders
                    .delete(getUrl() + "/" + validId + "/" + fileFieldName));
