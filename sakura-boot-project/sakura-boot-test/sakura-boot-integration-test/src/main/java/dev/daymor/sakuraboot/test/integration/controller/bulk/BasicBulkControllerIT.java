...
package dev.daymor.sakuraboot.test.integration.controller.bulk;
...
import dev.daymor.sakuraboot.bulk.api.business.BasicBulkService;
import dev.daymor.sakuraboot.bulk.api.presentation.BasicBulkController;
import dev.daymor.sakuraboot.test.integration.controller.bulk.controllers.DeleteAllControllerIT;
import dev.daymor.sakuraboot.test.integration.controller.bulk.controllers.PatchAllControllerIT;
import dev.daymor.sakuraboot.test.integration.controller.bulk.controllers.SaveAllControllerIT;
import dev.daymor.sakuraboot.test.integration.controller.bulk.controllers.UpdateAllControllerIT;
