...
import dev.daymor.sakuraboot.basic.api.business.services.SaveService;
import dev.daymor.sakuraboot.basic.api.presentation.controllers.SaveController;
...
/**
 * The interface for save controller integration tests.
 * <p>
 * <b>Example:</b>
 * </p>
 * <p>
 * To create a concrete controller test class that inherits from
 * {@link SaveControllerIT}, follow these steps:
 * </p>
 * <p>
 * Implements the {@link SaveControllerIT} class:
 * </p>
 * <blockquote>
 *
 * <pre>
 ...
 * public class YourIT //
 *     implements SaveControllerIT&lt;YourEntity, YourIdType, YourDataType&gt; {
 *
 ...
 * @since      0.1.0
 */
public interface SaveControllerIT<E extends DataPresentation<I>,
    ...
    default void testSave() throws Exception {
        ...
        result.andDo(MockMvcResultHandlers.print())
            ...
            .andExpect(MockMvcResultMatchers.header()
                .string("Location", getUrl() + "/" + entityWithId.getId()))
            .andExpect(MockMvcResultMatchers.content()
                .json(getJsonString(entityWithId)));
