...
package dev.daymor.sakuraboot.test.integration.controller.basic.controllers;
...
import dev.daymor.sakuraboot.basic.api.business.services.FindByIdService;
import dev.daymor.sakuraboot.basic.api.presentation.controllers.FindByIdController;
import dev.daymor.sakuraboot.test.SuperControllerTest;
import dev.daymor.sakuraboot.test.integration.controller.SuperControllerIT;
...
/**
 * The interface for find by id controller integration tests.
 * <p>
 * <b>Example:</b>
 * </p>
 * <p>
 * To create a concrete controller test class that inherits from
 * {@link FindByIdControllerIT}, follow these steps:
 * </p>
 * <p>
 * Implements the {@link FindByIdControllerIT} class:
 * </p>
 * <blockquote>
 *
 * <pre>
 ...
 * public class YourIT //
 *     implements //
 *     FindByIdControllerIT&lt;YourEntity, YourIdType, YourDataType&gt; {
 *
 ...
 * @since      0.1.0
 */
public interface FindByIdControllerIT<E extends DataPresentation<I>,
    I extends Comparable<? super I> & Serializable,
    D extends DataPresentation<I>> extends SuperControllerIT<E, I, D> {

    /**
     * Return a mock service that extends {@link FindByIdService}.
    ...
    default void testFindById() throws Exception {
        ...
        given(getService().findById(any())).willReturn(dataWithId);

        // WHEN
        final ResultActions result = getMockMvc()
            .perform(MockMvcRequestBuilders.get(getUrl() + "/{id}", validId));
