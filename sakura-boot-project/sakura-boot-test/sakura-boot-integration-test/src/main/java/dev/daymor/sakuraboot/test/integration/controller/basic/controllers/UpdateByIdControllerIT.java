...
import dev.daymor.sakuraboot.basic.api.business.services.UpdateByIdService;
import dev.daymor.sakuraboot.basic.api.presentation.controllers.UpdateByIdController;
...
/**
 * The interface for update by id controller integration tests.
 * <p>
 * <b>Example:</b>
 * </p>
 * <p>
 * To create a concrete controller test class that inherits from
 * {@link UpdateByIdControllerIT}, follow these steps:
 * </p>
 * <p>
 * Implements the {@link UpdateByIdControllerIT} class:
 * </p>
 * <blockquote>
 *
 * <pre>
 ...
 * public class YourIT //
 *     implements //
 *     UpdateByIdControllerIT&lt;YourEntity, YourIdType, YourDataType&gt; {
 *
 ...
 * @since      0.1.0
 */
public interface UpdateByIdControllerIT<E extends DataPresentation<I>,
