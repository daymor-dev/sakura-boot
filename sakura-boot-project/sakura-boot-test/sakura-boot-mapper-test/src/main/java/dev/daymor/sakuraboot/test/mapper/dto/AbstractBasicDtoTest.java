...
package dev.daymor.sakuraboot.test.mapper.dto;

import java.io.Serializable;

import dev.daymor.sakuraboot.mapper.dto.AbstractBasicDto;
import dev.daymor.sakuraboot.test.BasicTest;
import dev.daymor.sakuraboot.test.DataPresentationTest;
import dev.daymor.sakuraboot.test.mapper.MapperTest;
