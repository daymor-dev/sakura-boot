...
package dev.daymor.sakuraboot.test.basic.api.presentation;
...
import dev.daymor.sakuraboot.test.basic.api.presentation.controllers.DeleteByIdControllerTest;
import dev.daymor.sakuraboot.test.basic.api.presentation.controllers.FindAllControllerTest;
import dev.daymor.sakuraboot.test.basic.api.presentation.controllers.FindByIdControllerTest;
import dev.daymor.sakuraboot.test.basic.api.presentation.controllers.PatchByIdControllerTest;
import dev.daymor.sakuraboot.test.basic.api.presentation.controllers.SaveControllerTest;
import dev.daymor.sakuraboot.test.basic.api.presentation.controllers.UpdateByIdControllerTest;
