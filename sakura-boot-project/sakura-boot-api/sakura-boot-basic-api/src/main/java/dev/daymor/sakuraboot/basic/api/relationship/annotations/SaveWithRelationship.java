...
package dev.daymor.sakuraboot.basic.api.relationship.annotations;
...
/**
 * Annotation use on a method to handle the case the relationships already
 * exist.
 *
 * @author Malcolm Rozé
 * @since  0.1.0
...
@Documented
@LoggingAspect
public @interface SaveWithRelationship {
