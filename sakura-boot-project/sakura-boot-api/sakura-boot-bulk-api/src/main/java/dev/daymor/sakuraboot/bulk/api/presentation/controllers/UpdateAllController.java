...
package dev.daymor.sakuraboot.bulk.api.presentation.controllers;
...
import dev.daymor.sakuraboot.SuperController;
import dev.daymor.sakuraboot.bulk.api.business.services.UpdateAllService;
import dev.daymor.sakuraboot.hypermedia.api.annotations.ApplyHypermediaOnCollection;
import dev.daymor.sakuraboot.log.api.annotations.Logging;
import dev.daymor.sakuraboot.openapi.api.annotations.SwaggerBasicApiResponse;
import dev.daymor.sakuraboot.openapi.api.annotations.SwaggerNotFoundApiResponse;
import dev.daymor.sakuraboot.openapi.api.annotations.SwaggerOkApiResponse;
import dev.daymor.sakuraboot.openapi.api.annotations.SwaggerUpdateOperation;
