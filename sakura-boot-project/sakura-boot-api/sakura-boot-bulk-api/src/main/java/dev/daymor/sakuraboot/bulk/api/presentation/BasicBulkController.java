...
package dev.daymor.sakuraboot.bulk.api.presentation;

import java.io.Serializable;

import dev.daymor.sakuraboot.DataPresentation;
import dev.daymor.sakuraboot.bulk.api.business.BasicBulkService;
import dev.daymor.sakuraboot.bulk.api.presentation.controllers.DeleteAllController;
import dev.daymor.sakuraboot.bulk.api.presentation.controllers.PatchAllController;
import dev.daymor.sakuraboot.bulk.api.presentation.controllers.SaveAllController;
import dev.daymor.sakuraboot.bulk.api.presentation.controllers.UpdateAllController;
