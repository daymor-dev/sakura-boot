...
package dev.daymor.sakuraboot.openapi.api.annotations;
...
import dev.daymor.sakuraboot.exceptions.ErrorResponse;

/**
 * Meta-annotation representing the not found API response with HTTP status code
 * 404 (Not Found).
...
public @interface SwaggerNotFoundApiResponse {}
