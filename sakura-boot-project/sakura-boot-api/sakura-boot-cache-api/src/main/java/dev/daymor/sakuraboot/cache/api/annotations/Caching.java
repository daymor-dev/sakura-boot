...
package dev.daymor.sakuraboot.cache.api.annotations;
...
/**
 * Annotation used on a method to cache the result.
 *
 * @author Malcolm Rozé
 * @since  0.1.0
 */
...
public @interface Caching {
    ...
    /**
     * This value will be concatenated to the cache use for this method. Can
     * be useful to use the "All" caches.
     *
     * @return A string to concatenate to the cache name.
     */
    String concatToCacheName() default "";
