...
package dev.daymor.sakuraboot.specification.api.relationship.annotations;
...
/**
 * Annotation use on a method to use a join fetch if needed.
 *
 * @author Malcolm Rozé
 * @since  0.1.0
 */
...
@Documented
@LoggingAspect
public @interface FindAllByCriteriaWithRelationship {
    ...
    /**
     * A boolean to activate the logging if the target instance is not of type
     * {@link Loggable}.
