...
import dev.daymor.sakuraboot.example.complexhypermediamodule.business.HobbyService;
import dev.daymor.sakuraboot.example.complexhypermediamodule.persistence.Hobby;
import dev.daymor.sakuraboot.example.complexhypermediamodule.presentation.HobbyController;
import dev.daymor.sakuraboot.example.complexhypermediamodule.presentation.model.HobbyModelAssembler;
import dev.daymor.sakuraboot.example.complexhypermediamodule.util.HobbyITUtil;
